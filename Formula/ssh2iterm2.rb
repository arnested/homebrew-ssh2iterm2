...
class Ssh2iterm2 < Formula
  ...
  on_macos do
    url "https://github.com/arnested/ssh2iterm2/releases/download/v1.0.38/ssh2iterm2_1.0.38_darwin_amd64.tar.gz"
    sha256 "15d6a0b5b3abd1decd1bab4cbc2f2447076f4514f834b985bb7c30bc2501151f"
