...
class Ssh2iterm2 < Formula
  ...
  on_macos do
    url "https://github.com/arnested/ssh2iterm2/releases/download/v1.0.82/ssh2iterm2_1.0.82_darwin_amd64.tar.gz"
    sha256 "5486c4947286545391cc126aacaedf9274249cfae990f67f57d87550149942a3"
