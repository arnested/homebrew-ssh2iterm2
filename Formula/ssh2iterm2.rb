...
class Ssh2iterm2 < Formula
  ...
  if OS.mac?
    url "https://github.com/arnested/ssh2iterm2/releases/download/v1.0.1/ssh2iterm2_1.0.1_darwin_amd64.tar.gz"
    sha256 "c59aba99ebc3d2a82ba052ef29264e487c0706c29791715ad693b769f90bd8fc"
  end
